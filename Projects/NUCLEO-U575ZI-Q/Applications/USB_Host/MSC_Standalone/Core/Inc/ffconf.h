...
/* When FF_LFN_UNICODE >= 1, this option selects the character encoding ON THE FILE to
...
/  3: UTF-8
/
/  This option has no effect when FF_LFN_UNICODE == 0. */
...
#define FF_FS_NOFSINFO    0 /* 0,1,2 or 3 */
...
#define FF_NORTC_YEAR   2023      /* default value: 2023 in R15 */
...
#define FF_FS_LOCK    2     /* 0:Disable or >=1:Enable */
...
/
/   0: Disable re-entrancy. _FS_TIMEOUT has no effect.
